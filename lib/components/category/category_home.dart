            ...
            onPressed: () {
              Navigator.of(context).push(MaterialPageRoute(
                  builder: (context) => AllMedicineList(
                      medicineList:
                          Get.find<MedicineController>().medicineList)));
            },
          ...
          child: GridView.builder(
              ...
              itemBuilder: (BuildContext context, int index) {
                return Padding(
                  ...
                  child: Single_cate(
                    medicineList: Get.find<MedicineController>()
                        .medicineList
                        .where((element) =>
                            element.category.toLowerCase() ==
                            product_list[index]['name'].toLowerCase())
                        .toList(),
    ...
    return Card(
      ...
      child: InkWell(
        onTap: () => Navigator.of(context).push(
          MaterialPageRoute(
            builder: (context) => AllMedicineList(medicineList: medicineList),
          ),
        ),
        child: GridTile(
            footer: Container(
