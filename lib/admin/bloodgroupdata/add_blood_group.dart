...
class AddBloodGroupPage extends StatefulWidget {
  AddBloodGroupPage({Key key}) : super(key: key);

  @override
  State<AddBloodGroupPage> createState() => _AddBloodGroupPageState();
}

class _AddBloodGroupPageState extends State<AddBloodGroupPage> {
        ...
        Padding(
          ...
          child: TextField(
            ...
            decoration: const InputDecoration(
                hintText: 'A, B, AB, O (Negative or Positive)'),
            // validator: (value) {
            //   if (value.isEmpty) {
